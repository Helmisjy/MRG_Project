                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                    ...
                                    <?php if ($config->allowRemembering) : ?>
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                <input type="checkbox" class="custom-control-input" name="remember" <label class="custom-control-label" for="customCheck"><?php if (old('remember')) : ?> checked <?php endif ?>>
                                ...
                                <?php if ($config->allowRegistration) : ?>
                                    <div class="text-center">
                                        <a class="small" href="<?php route_to('register') ?>"><?php lang('auth.needAnAccount') ?></a>
                                    </div>
                                <?php endif; ?>

                                <?php if ($config->activeResetter) : ?>
                                    <div class="text-center">
                                        <a class="small" href="<?php route_to('forgot') ?>"><?php lang('auth.forgotYourPassword') ?></a>
                                    </div>
                                <?php endif; ?>
